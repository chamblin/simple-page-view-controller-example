...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    colorPagesDataSource = [[ColorPagesDataSource alloc] init];
    pvc.dataSource = colorPagesDataSource;
    
    [pvc setViewControllers:[NSArray arrayWithObjects:[[ColorViewController alloc] initWithColor:[UIColor redColor]], nil] direction:UIPageViewControllerNavigationDirectionForward animated:YES completion:nil];
